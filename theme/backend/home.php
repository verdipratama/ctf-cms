    ...
    <div class="row">
      <div class="col-lg-3 col-md-6">
        <div class="card widget-flat">
          <div class="card-body">
            <h5 class="fw-bold mt-0" title="Number of Customers">Challenge</h5>
            <h3 class="mb-0"><?=$chall_count?></h3>
          </div> <!-- end card-body-->
        </div> <!-- end card-->
      </div> <!-- end col-->
      <div class="col-lg-3 col-md-6">
        <div class="card widget-flat">
          <div class="card-body">
            <h5 class="fw-bold mt-0" title="Number of Customers">Users Register
            </h5>
  ...
  <div class="col-12">
    <div class="card card-h-100">
      <div class="card-body">
        ...
        <div dir="ltr">
          <div id="sessions-overview" class="apex-charts mt-3"
  ...
  TodoApp.prototype.initCharts = function() {
    ...
    var DEFAULT_TYPE_TEXT_MULTI = function(month, StartDate) {
      ...
      for (; startDate.getMonth() === month && prize < 15;) {
        ...
        newNodeLists.push(date.getDate() + " " + date.toLocaleString(
          "en-US", {
            day: "short",
    ...
    (new ApexCharts(document.querySelector("#sessions-overview"), options))
    .render();
  };
