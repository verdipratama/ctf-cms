...
<head>
  ...
  <link href="<?=_backEnd()?>css/vendor/jquery-jvectormap-1.2.2.css"
    rel="stylesheet" type="text/css" />
  <link href="<?=_backEnd()?>css/icons.min.css" rel="stylesheet"
    type="text/css" />
  <link href="<?=_backEnd()?>css/app.min.css" rel="stylesheet" type="text/css"
    id="light-style" />
  <link href="<?=_backEnd()?>css/app-dark.min.css" rel="stylesheet"
    type="text/css" id="dark-style" />
  <link href="<?=_backEnd()?>toastr/toastr.min.css" rel="stylesheet"
    type="text/css" id="dark-style" />
</head>
    ...
    <div class="leftside-menu">
      ...
      <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <ul class="side-nav">
          ...
          <li class="side-nav-item">
            <a data-bs-toggle="collapse" href="#challenge" aria-expanded="false"
              aria-controls="spage" class="side-nav-link">
              <i class="uil-code"></i>
            ...
            <div class="collapse" id="challenge">
              <ul class="side-nav-second-level">
                <li>
                  <a href="<?=base_url("admin/challenge/create")?>">New
                    Challenge</a>
                </li>
                <li>
                  <a href="<?=base_url("admin/challenge")?>">Challenge
                    Manager</a>
                </li>
                <li>
                  <a href="<?=base_url("admin/category")?>">Category Manager</a>
                </li>
              </ul>
            </div>
          </li>
          <li class="side-nav-item">
            <a data-bs-toggle="collapse" href="#spage" aria-expanded="false"
              aria-controls="spage" class="side-nav-link">
          ...
          <li class="side-nav-item">
            <a data-bs-toggle="collapse" href="#webs" aria-expanded="false"
              aria-controls="webs" class="side-nav-link">
            ...
            <div class="collapse" id="webs">
              <ul class="side-nav-second-level">
                <li>
                  <a href="<?=base_url("admin/websettings")?>">General
                    Settings</a>
                </li>
                <li>
                  <a href="<?=base_url("admin/websettings/menus")?>">Site
                    Menus</a>
                </li>
              </ul>
            </div>
          ...
          <li class="side-nav-item">
            ...
            <div class="collapse" id="sidebarLayouts">
              <ul class="side-nav-second-level">
                <li>
                  <a href="<?=base_url("admin/webmaster")?>">General
                    Settings</a>
                </li>
              </ul>
            </div>
        ...
        <div class="help-box text-white text-center">
          ...
          <h5 class="mt-3">VELIXS PANEL</h5>
          <a class="btn btn-primary" href="https://app.velixs.com/sources/6">CEK
            UPDATE</a>
        </div>
        <!-- end Help Box -->
        <!-- End Sidebar -->
            ...
            <li class="dropdown notification-list">
              ...
              <div
                ...
                <div class="p-2">
                  <div class="row g-0">
                    <div class="col">
                      <a class="dropdown-icon-item" href="<?=base_url("")?>"
                        target="_blank">
                        <i class="uil-home text-success"
                    ...
                    <div class="col">
                      <a class="dropdown-icon-item"
                        href="<?=base_url("admin/icons")?>">
                        <i class="uil-window-grid text-danger"
                          style="font-size: 25px;"></i>
            ...
            <li class="dropdown notification-list">
              <a class="nav-link dropdown-toggle nav-user arrow-none me-0"
                ...
                <span class="account-user-avatar">
                  <img src="<?=_storage("avatar/$akun->avatar")?>"
              ...
              <div
                ...
                <!-- item-->
                <a href="<?=base_url("users/$akun->username")?>"
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-6">
              ...
              </script> © AdminPanel by <a
                href="https://velixs.com">velixs.com</a>
            </div>
          </div>
        </div>
      </footer>
