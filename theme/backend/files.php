  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-pat=""
          id="detail_delete" data-de="" data-bs-dismiss="modal">Delete</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
$("#detail_delete").click(function() {
  ...
  if (result) {
    ...
    xhttp.open("GET", "<?=base_url("admin/storage?cmd=delfile&name=")?>" +
