  ...
  <div class="row">
    <div class="col-xl-3 col-lg-4 col-12">
      <div class="card card-body">
        <button type="button" class="mb-2 btn btn-success dropdown-toggle w-100"
          data-bs-toggle="dropdown" aria-haspopup="true"
          aria-expanded="false"><i class="mdi mdi-plus"></i> Create New
        </button>
        <div class="dropdown-menu">
          <a class="dropdown-item" id="mfolder" href="javascript:void(0)"
            data-bs-toggle="modal" data-bs-target="#addfolder"><i
              class="mdi mdi-folder-plus-outline me-1"></i> Folder</a>
          <a class="dropdown-item" id="addfiles" href="javascript:void(0)"
            data-bs-toggle="modal" data-bs-target="#addfile"><i
              class="mdi mdi-upload me-1"></i> Upload File</a>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-6">
            <div class="card m-0 shadow-none border mb-1">
              <div class="p-2">
                <a data-bs-toggle="dropdown" role="button" aria-haspopup="false"
                ...
                <div
                  class="dropdown-menu dropdown-menu-start dropdown-menu-animated topbar-dropdown-menu profile-dropdown">
                  <!-- item-->
                  <a href="javascript:void(0)" data-folder="<?="$oripath$d"?>"
                    class="dropdown-item notify-item inifolder">
                  ...
                  <a href="javascript:void(0)"
                    class="dropdown-item notify-item text-danger deletefolder"
                    data-folder="<?="$oripath$d"?>">
        ...
        <div class="row">
          ...
          <div class="col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
            <a class="text-dark" href="javascript:void(0)"
              data-bs-toggle="modal" data-bs-target="#preview">
              <div class="card mb-2">
                <img class="card-img img-cover detail" name-file="<?=$d?>"
                  data-file="<?=_storage("$path$d")?>"
                  style="object-fit: cover;" height="80"
                  src="<?=_storage("$path$d")?>">
                <div class="card-footer rounded p-0"
      ...
      <div class="modal-body">
        <form id="addfolderfrm">
          <div class="mb-1">
            ...
            <input class="form-control" name="folder" type="text" id="folder"
              required="">
          </div>
          <div class="text-end">
            <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
              aria-hidden="true" type="submit">Create</button>
          </div>
        </form>
      </div>
    </div><!-- /.modal-content -->
...
<div class="modal fade" id="addfile" data-bs-backdrop="static"
...
delte_folder.click(function() {
  ...
  if (result) {
    ...
    xhttp.open("GET", "<?=base_url("admin/storage?cmd=delfolder&name=")?>" +
