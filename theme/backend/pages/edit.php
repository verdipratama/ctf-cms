        ...
        <form action="" method="POST" enctype="multipart/form-data">
          <div class="d-flex justify-content-end mb-3">
            ...
            <button class="btn btn-secondary" type="submit" name="save"
              value="saveexit">Update & Exit</button>
          </div>
          <ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
            <li class="nav-item">
              <a href="#general" data-bs-toggle="tab" aria-expanded="true"
            ...
            <li class="nav-item">
              <a href="#seo" data-bs-toggle="tab" aria-expanded="false"
              ...
              <div class="row">
                <div class="col-12">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control seo_input"
                      name="title" id="i_title" value="<?=$row->title?>"
                  ...
                  <div class="mb-3">
                    ...
                    <select class="form-control" name="status" required>
                      <option value="1"
                        <?=($row->status == 1) ? 'selected' : ''?>>On</option>
                      <option value="0"
                        <?=($row->status == 0) ? 'selected' : ''?>>Off</option>
                    </select>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-xl-6 col-lg-6 col-12">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control seo_input"
                      name="seo_slug" id="seo_slug" value="<?=$row->seo_slug?>"
                      required>
                  </div>
                  <div class="mb-3">
                    <label class="form-label">SEO Description</label>
                    <textarea type="text" class="form-control seo_input"
                      rows="6" name="seo_description"
                      id="seo_description"><?=$row->seo_description?></textarea>
                  </div>
                  <div class="mb-3">
                    <label class="form-label">SEO Keywords</label>
                    <input type="text" class="form-control" name="seo_keywords"
                      id="seo_keywords" value="<?=$row->seo_keywords?>">
                  </div>
                </div>
                <div class="col">
                  <div class="card border" style="background: #f9f9f9;">
                    <div class="card-body">
                      <h4 class="m-0" style="color: #1a0cab;" id="title_rev">
                        <?=$row->title?></h4>
                      <div style="color: #006622;" id="slug_rev">
                        <?=$row->seo_slug?></div>
                      <small
                        id="description_rev"><?=$row->seo_description?></small>
                    </div>
                  </div>
                  <small><i class="uil-comment-notes"></i> Mange your page
                    title, meta description, keywords and unique friendly URL.
                    This help you to manage how this topic shows up on search
                    engines.</small>
                </div>
              </div>
            </div>
