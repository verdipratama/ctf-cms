          ...
          <div class="col-sm-4">
            <a href="<?=base_url("admin/pages/create")?>"
              class="btn btn-success mb-2"><i
                class="mdi mdi-plus-circle me-2"></i> New Page</a>
          </div>
          <div class="col-sm-8">
        ...
        <table id="basic-datatable" class="table dt-responsive">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <?=($p->status == 1) ? '<span class="badge bg-success">ON</span>' : '<span class="badge bg-secondary">OFF</span>'?>
              </td>
              <td>
                <?=count_visitor('site_pages', $p->id)?>
              </td>
              <td class="table-action">
                <a href="<?=base_url($p->seo_slug)?>" target="_blank"
                  class="action-icon"> <i class="mdi mdi-eye"></i></a>
                <a href="<?=base_url("admin/pages/edit/$p->id")?>"
                  class="action-icon"> <i
