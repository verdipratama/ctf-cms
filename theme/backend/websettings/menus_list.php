          ...
          <div class="col-sm-4">
            <a href="javascript:void(0)" data-bs-toggle="modal"
              data-bs-target="#modaladd" class="btn btn-success mb-2"><i
                class="mdi mdi-plus-circle me-2"></i> New Menus</a>
          </div>
          <div class="col-sm-8">
            <div class="text-sm-end">
              <button type="button"
                class="btn btn-primary mb-2 me-1">Import</button>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="table-action">
                ...
                <a href="<?=base_url("admin/websettings/menus_edit/$c->id")?>"
                  class="action-icon"> <i
                    class="mdi mdi-square-edit-outline"></i></a>
                <a href="<?=base_url("admin/websettings/menus_delete/$c->id")?>"
      ...
      <form action="" method="POST">
        <div class="modal-body">
          ...
          <div class="mb-3 linkurl" style="display: block;">
            ...
            <input type="text" class="form-control linkurl" name="link_url"
