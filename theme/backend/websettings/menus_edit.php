        ...
        <form action="" method="post">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="title"
              value="<?=$row->title?>" placeholder="Title Menus" required>
          </div>
          <div class="mb-3">
            <label for="example-select" class="form-label">Type Menus</label>
            <select class="form-select type_menu" name="type">
              <option value="direct"
                <?=($row->type == 'direct') ? "selected" : ""?>>Direct Link
              </option>
              <option value="dropdown"
                <?=($row->type == 'dropdown') ? "selected" : ""?>>Drop Down
              </option>
            </select>
          </div>
          <div class="mb-3 linkurl" style="display: block;">
            ...
            <input type="text" class="form-control" name="link"
              value="<?=$row->link?>" placeholder="Enter link">
          </div>
          <div class="mb-3">
