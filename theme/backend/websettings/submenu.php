<!-- third party css -->
<link href="<?=_backEnd()?>css/vendor/dataTables.bootstrap5.css"
  rel="stylesheet" type="text/css" />
<link href="<?=_backEnd()?>css/vendor/responsive.bootstrap5.css"
  rel="stylesheet" type="text/css" />
        ...
        <div class="row mb-2">
          <div class="col-sm-4">
            <a href="javascript:void(0)" data-bs-toggle="modal"
              data-bs-target="#modaladd" class="btn btn-success mb-2"><i
                class="mdi mdi-plus-circle me-2"></i> New Sub Menu</a>
          </div>
          <div class="col-sm-8">
            <div class="text-sm-end">
              <a href="<?=base_url("admin/websettings/menus")?>"
                class="btn btn-primary mb-2 me-1">Back Menus</a>
            </div>
          </div><!-- end col-->
        </div>
        ...
        <table id="basic-datatable" class="table dt-responsive">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?=$for?></td>
              <td>
                <?=($c->status == 1) ? '<span class="badge bg-success">ON</span>' : '<span class="badge bg-secondary">OFF</span>'?>
              </td>
              <td class="table-action">
                <a href="<?=base_url("admin/websettings/menus/sub/$sub_id/edit/$c->id")?>"
                  class="action-icon"> <i
                    class="mdi mdi-square-edit-outline"></i></a>
                <a href="<?=base_url("admin/websettings/menus/sub/$sub_id/delete/$c->id")?>"
                  class="action-icon delete-confirm"> <i
      ...
      <form action="" method="POST">
        <div class="modal-body">
          ...
          <div class="mb-3 linkurl" style="display: block;">
            ...
            <input type="text" class="form-control linkurl" name="link"
        ...
        <div class="modal-footer">
          <div class="d-flex justify-content-end">
            <button class="btn btn-primary" type="submit"><i
                class="mdi mdi-plus-circle me-2"></i> Add</button>
          </div>
        </div>
      </form>
    </div><!-- /.modal-content -->
