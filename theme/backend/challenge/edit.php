        ...
        <form action="" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-12 col-xxl-6 col-xl-6 col-lg-6 col-md-6">
              <div class="mb-3">
                <label class="form-label">Title Chall</label>
                <input type="text" class="form-control" name="title"
                  value="<?=$row->title?>" placeholder="Title Challenge"
                  required>
              </div>
            </div>
            <div class="col-12 col-xxl-6 col-xl-6 col-lg-6 col-md-6">
            ...
            <div class="col-12 col-xxl-6 col-xl-6 col-lg-6 col-md-6">
              <div class="mb-3">
                ...
                <select class="form-control" name="category" required>
                  ...
                  <option <?=($row->category == $c->cate_id) ? "selected" : ""?>
                    value="<?=$c->cate_id?>"><?=$c->cate_title?></option>
                  <?php endforeach?>
                </select>
              </div>
            </div>
            <div class="col-12 col-xxl-6 col-xl-6 col-lg-6 col-md-6">
              <div class="mb-3">
                ...
                <select class="form-control" name="level" required>
                  <option <?=($row->level == "easy") ? "selected" : ""?>
                    value="easy">Easy</option>
                  <option <?=($row->level == "normal") ? "selected" : ""?>
                    value="normal">Normal</option>
                  <option <?=($row->level == "hard") ? "selected" : ""?>
                    value="hard">Hard</option>
                  <option <?=($row->level == "expert") ? "selected" : ""?>
            ...
            <div class="col-12 col-xxl-6 col-xl-6 col-lg-6 col-md-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control seo_input" name="flag"
                  value="<?=$row->flag?>" placeholder="Flag" required>
              </div>
            </div>
            <div class="col-12 col-xxl-6 col-xl-6 col-lg-6 col-md-6">
              <div class="mb-3">
                ...
                <input type="number" class="form-control seo_input" name="score"
                  value="<?=$row->score?>" placeholder="Score Challenge"
                  required>
              </div>
            </div>
          </div>
