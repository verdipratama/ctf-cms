        ...
        <div class="row mb-2">
          <div class="col-sm-4">
            <a href="javascript:void(0)" data-bs-toggle="modal"
              data-bs-target="#modal-add" class="btn btn-success mb-2"><i
                class="mdi mdi-plus-circle me-2"></i> New Category</a>
          </div>
          <div class="col-sm-8">
          </div><!-- end col-->
        </div>
        ...
        <table id="basic-datatable" class="table dt-responsive">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <i class="<?=$c->cate_icon?>"></i> <?=$c->cate_title?>
              </td>
              <td><?=$c->created_at?></td>
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-end">
                    <a href="javascript:void(0)"
                      onclick='edit("<?=$c->cate_id?>")' class="dropdown-item">
                      <i class="mdi mdi-square-edit-outline"></i> Edit</a>
                    <a href="<?=base_url("admin/category/delete/$c->cate_id")?>"
                      class="delete-confirm dropdown-item"> <i
...
function edit(id) {
  ...
  $("#content-modal-edit").html(
    '<div class="text-center"><div class="spinner-border" role="status"><span class="visually-hidden">Loading...</span></div></div>'
    );
  $("#content-modal-edit").load("<?=base_url("admin/category/edit/")?>" + id)
}
</script>