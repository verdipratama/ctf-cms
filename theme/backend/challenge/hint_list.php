  ...
  <div class="col-12">
    <div class="card">
      <div class="card-body">
        <div class="row mb-2">
          <div class="col-sm-4">
            <a href="<?=base_url("admin/hint/$id_chall/create")?>"
              class="btn btn-success mb-2"><i
                class="mdi mdi-plus-circle me-2"></i> New Hint</a>
          </div>
          <div class="col-sm-8">
          </div><!-- end col-->
        </div>
              ...
              <td class="table-action">
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-end">
                    <a href="<?=base_url("admin/hint/$id_chall/edit/$c->id")?>"
                      class="dropdown-item"> <i
                        class="mdi mdi-square-edit-outline"></i> Edit</a>
                    <a href="<?=base_url("admin/hint/$id_chall/delete/$c->id")?>"
